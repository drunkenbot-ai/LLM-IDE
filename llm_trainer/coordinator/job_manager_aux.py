...
from llm_trainer.coordinator.job_models import WorkerDescriptor, WorkerStatus
...
class JobManagerAux:
    ...
    def _restore_state(self) -> None:
        ...
        from llm_trainer.coordinator.job_manager_impl import _managed_job_from_jsonable
