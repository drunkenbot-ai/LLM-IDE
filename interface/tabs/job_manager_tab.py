...
def build_job_manager_tab(window) -> QWidget:
    ...
    window.cluster_train_time_label = QLabel("Train Time: -")
    window.cluster_train_time_label.setObjectName("Metric")
    window.cluster_train_time_label.setStyleSheet("color: #38bdf8; font-weight: 700;")
    window.cluster_sync_time_label = QLabel("Sync Time: -")
    window.cluster_sync_time_label.setObjectName("Metric")
    window.cluster_sync_time_label.setStyleSheet("color: #f59e0b; font-weight: 700;")
    ...
    title_row.addWidget(window.cluster_train_time_label)
    title_row.addWidget(window.cluster_sync_time_label)
    ...
    # Cluster Fleet Runtime Configuration (Derived automatically from Training Tab)
    hparams_row = QHBoxLayout()
    hparams_row.setSpacing(12)
    ...
    window.cluster_auto_sync_epochs = QCheckBox()
    ...
    hparams_row.addWidget(QLabel("<b>Min Workers:</b>"))
    hparams_row.addWidget(window.cluster_min_workers)

    window.cluster_sync_info_label = QLabel("⚡ Fleet Plan: Auto-derived from Training Tab settings...")
    window.cluster_sync_info_label.setObjectName("Metric")
    window.cluster_sync_info_label.setWordWrap(True)
    window.cluster_sync_info_label.setStyleSheet("color: #4ade80; font-size: 11px; padding: 2px 8px;")
    hparams_row.addWidget(window.cluster_sync_info_label, 1)
