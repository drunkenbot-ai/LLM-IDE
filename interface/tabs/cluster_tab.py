...
def build_cluster_card(window) -> QWidget:
    ...
    # Internal Local SGD Controls (automatically derived from Training tab)
    ...
    status_row.addWidget(window.cluster_train_time_label)
    status_row.addWidget(window.cluster_sync_time_label)
