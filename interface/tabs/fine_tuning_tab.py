...
def build_fine_tuning_tab(window) -> QWidget:
    ...
    window.fine_tune_process_status.setObjectName("Metric")
    window.fine_tune_process_status.setWordWrap(True)
    runtime_form.addRow("Launch", window.fine_tune_launch_target)
    runtime_form.addRow("Process", window.fine_tune_process_status)
    ...
    window.stop_fine_tune_button.clicked.connect(window.stop_training_process)
